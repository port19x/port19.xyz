...
var vec__2537 = axis;
var a_x = cljs.core.nth.call(null,vec__2537,(0),null);
var a_y = cljs.core.nth.call(null,vec__2537,(1),null);
var a_z = cljs.core.nth.call(null,vec__2537,(2),null);
var vec__2540 = v;
var x = cljs.core.nth.call(null,vec__2540,(0),null);
var y = cljs.core.nth.call(null,vec__2540,(1),null);
var z = cljs.core.nth.call(null,vec__2540,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__2543,p__2544){
var vec__2545 = p__2543;
var u1 = cljs.core.nth.call(null,vec__2545,(0),null);
var u2 = cljs.core.nth.call(null,vec__2545,(1),null);
var u3 = cljs.core.nth.call(null,vec__2545,(2),null);
var vec__2548 = p__2544;
var v1 = cljs.core.nth.call(null,vec__2548,(0),null);
var v2 = cljs.core.nth.call(null,vec__2548,(1),null);
var v3 = cljs.core.nth.call(null,vec__2548,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__2551_SHARP_){
return (p1__2551_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__2552_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__2553_SHARP_,angle_lr),angle_ud);
...
var map__2555 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
...
var up = cljs.core.get.call(null,map__2555__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__2555__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__5733__auto__ = (function (){var pred__2557 = cljs.core._EQ_;
var expr__2558 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__2557.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__2558))){
return straight;
} else {
if(cljs.core.truth_(pred__2557.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__2558))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__2557.call(null,quil.middlewares.navigation_3d.space,expr__2558))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__2557.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__2558))){
return up;
} else {
if(cljs.core.truth_(pred__2557.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__2558))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__2557.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__2558))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__5733__auto__,map__2555,map__2555__$1,up,straight){
return (function (p1__2554_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__2554_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__5733__auto__,map__2555,map__2555__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__2560_SHARP_);
});})(initial_state))
);
});
/**
...
var map__2561_2572 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__2561_2573__$1 = (((((!((map__2561_2572 == null))))?(((((map__2561_2572.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__2561_2572.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__2561_2572):map__2561_2572);
var vec__2562_2574 = cljs.core.get.call(null,map__2561_2573__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_2575 = cljs.core.nth.call(null,vec__2562_2574,(0),null);
var c_y_2576 = cljs.core.nth.call(null,vec__2562_2574,(1),null);
var c_z_2577 = cljs.core.nth.call(null,vec__2562_2574,(2),null);
var vec__2565_2578 = cljs.core.get.call(null,map__2561_2573__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_2579 = cljs.core.nth.call(null,vec__2565_2578,(0),null);
var u_y_2580 = cljs.core.nth.call(null,vec__2565_2578,(1),null);
var u_z_2581 = cljs.core.nth.call(null,vec__2565_2578,(2),null);
var vec__2568_2582 = cljs.core.get.call(null,map__2561_2573__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_2583 = cljs.core.nth.call(null,vec__2568_2582,(0),null);
var p_y_2584 = cljs.core.nth.call(null,vec__2568_2582,(1),null);
var p_z_2585 = cljs.core.nth.call(null,vec__2568_2582,(2),null);
quil.core.camera.call(null,p_x_2583,p_y_2584,p_z_2585,(p_x_2583 + c_x_2575),(p_y_2584 + c_y_2576),(p_z_2585 + c_z_2577),u_x_2579,u_y_2580,u_z_2581);
